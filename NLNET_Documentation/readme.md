# Overview
This document provides supplementary context for the SHSM project. It covers:
- How SHSM differs from existing software HSM solutions
...
1. Differences with other SHSMs
