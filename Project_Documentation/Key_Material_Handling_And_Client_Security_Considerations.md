...
**```12th section of this readme content only makes sense if it's coming from NLNET that had my first initial proposal towards the project. It can also makes sense if one have the right expertise that comes from understanding PKI and programming as a whole.```**
