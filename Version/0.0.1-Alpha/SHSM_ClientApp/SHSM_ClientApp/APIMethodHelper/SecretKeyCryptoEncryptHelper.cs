...
{
    public static class SecretKeyCryptoEncryptHelper
    {
        public static String SecretKeyCryptoEncrypt(String JSONString) 
        {
            String OutputString = "";
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsync("SecretKeyCryptography", content);
                response.Wait();
