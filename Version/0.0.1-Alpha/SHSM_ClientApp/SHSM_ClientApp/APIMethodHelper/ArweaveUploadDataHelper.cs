...
{
    public static class ArweaveUploadDataHelper
    {
        public static String ArweaveUploadData(String JSONString) 
        {
            String OutputString = "";
            using (var client = new HttpClient())
            {
                ...
                var response = client.PostAsync("ArweaveRSAOps", content);
                response.Wait();
