...
If there're, the fallback symmetric encryption algorithms need to be stream ciphers like XChaCha20 or XSalsa20 and paired them with MAC (Message Authentication Code)
algorithms.
